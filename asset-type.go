...
var DEFAULT_ASSETS = AvailableAssets{
	...
	Asset.SPOT_PRICE: {
		...
		"Spot Price (Binance)", "The current price at which an asset is bought or sold in the spot market on Binance.",
	},
	Asset.SPOT_VOLUME: {
		Asset.SPOT_VOLUME, QUANTITY, nil, nil,
		"Spot Volume (Binance)", "The total amount of an asset traded in the spot market on Binance.",
	},

	// Binance order book depth
	Asset.BOOK_DEPTH_P1: {
		Asset.BOOK_DEPTH_P1, UNIT, nil, nil,
		"Liquidity +1% Price (Binance)", "Available liquidity at a price level 1% above the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_P2: {
		Asset.BOOK_DEPTH_P2, UNIT, nil, nil,
		"Liquidity +2% Price (Binance)", "Available liquidity at a price level 2% above the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_P3: {
		Asset.BOOK_DEPTH_P3, UNIT, nil, nil,
		"Liquidity +3% Price (Binance)", "Available liquidity at a price level 3% above the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_P4: {
		Asset.BOOK_DEPTH_P4, UNIT, nil, nil,
		"Liquidity +4% Price (Binance)", "Available liquidity at a price level 4% above the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_P5: {
		Asset.BOOK_DEPTH_P5, UNIT, nil, nil,
		"Liquidity +5% Price (Binance)", "Available liquidity at a price level 5% above the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_M1: {
		Asset.BOOK_DEPTH_M1, UNIT, nil, nil,
		"Liquidity -1% Price (Binance)", "Available liquidity at a price level 1% below the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_M2: {
		Asset.BOOK_DEPTH_M2, UNIT, nil, nil,
		"Liquidity -2% Price (Binance)", "Available liquidity at a price level 2% below the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_M3: {
		Asset.BOOK_DEPTH_M3, UNIT, nil, nil,
		"Liquidity -3% Price (Binance)", "Available liquidity at a price level 3% below the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_M4: {
		Asset.BOOK_DEPTH_M4, UNIT, nil, nil,
		"Liquidity -4% Price (Binance)", "Available liquidity at a price level 4% below the current market price on Binance.",
	},
	Asset.BOOK_DEPTH_M5: {
		Asset.BOOK_DEPTH_M5, UNIT, nil, nil,
		"Liquidity -5% Price (Binance)", "Available liquidity at a price level 5% below the current market price on Binance.",
	},
	...
	Asset.METRIC_COUNT_TOP_TRADER_LONG_SHORT_RATIO: {
		...
		"Taker Long/Short Ratio (Binance)", "The ratio of long to short positions taken by top traders on Binance.",
	},
	Asset.METRIC_SUM_TOP_TRADER_LONG_SHORT_RATIO: {
		Asset.METRIC_SUM_TOP_TRADER_LONG_SHORT_RATIO, UNIT, nil, nil,
		"Top Trader Long/Short Ratio (Binance)", "The ratio of the sum of long to short positions taken by top traders on Binance.",
	},
	Asset.METRIC_COUNT_LONG_SHORT_RATIO: {
		Asset.METRIC_COUNT_LONG_SHORT_RATIO, UNIT, nil, nil,
		"Long/Short Ratio (Binance)", "The overall ratio of long to short positions taken by all traders on Binance.",
	},
	Asset.METRIC_SUM_TAKER_LONG_SHORT_VOL_RATIO: {
		Asset.METRIC_SUM_TAKER_LONG_SHORT_VOL_RATIO, UNIT, nil, nil,
		"Taker Long/Short Volume Ratio (Binance)", "The ratio of long to short volumes taken by top traders on Binance.",
	},

	// Supply
	Asset.CIRCULATING_SUPPLY: {
		Asset.CIRCULATING_SUPPLY, UNIT, nil, nil,
		"Circulating Supply", "The total number of tokens that are currently available in the market and in circulation.",
	},

	// Binance futures
	Asset.FUTURES_PRICE: {
		Asset.FUTURES_PRICE, UNIT, nil, nil,
		"Futures Price (Binance)", "The current price at which a futures contract is trading on Binance.",
	},
	Asset.FUTURES_VOLUME: {
		Asset.FUTURES_VOLUME, QUANTITY, nil, nil,
		"Futures Volume (Binance)", "The total amount of futures contracts traded on Binance.",
	},
